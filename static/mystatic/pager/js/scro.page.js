...
!function ($) {
	 ...
	 * 模板
	 */
	var template = '<div style="float:left;width:75%"><div style="float: left;margin-left:10px;"><input type="button" id="pagerAddBtn"  style="display: none;" value="增加" onclick="addInfo();" class="btn btn-info">'+
